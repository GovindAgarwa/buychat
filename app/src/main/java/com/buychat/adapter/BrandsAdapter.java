...
public class BrandsAdapter extends RecyclerView.Adapter< RecyclerView.ViewHolder>{
    ...
    public BrandsAdapter(Context context,ArrayList<BrandsPojo> mListData, ImageLoader imageLoader, BrandsActivity.ImageDisplayListener imageListener, DisplayImageOptions options) {
    ...
    public void onBindViewHolder(final  RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ProgressViewHolder) {
            ...
            if (holder instanceof MyViewHolder) {
                ...
                ((MyViewHolder) holder).titleMarket.setText(mListData.get(position).getBusiness_name());

                loader.displayImage(mListData.get(position).getBusiness_image(), ((MyViewHolder) holder).image, options, new SimpleImageLoadingListener() {
