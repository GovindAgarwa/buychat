...
public class EventsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public EventsAdapter(Context context, List<ShopsPojo> mListData, CustomClickListner onItemClickClistner) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.logos_type) TextView type;
        @BindView(R.id.map_address) TextView map_address;
    //    @BindView(R.id.order_time) TextView order_time;
