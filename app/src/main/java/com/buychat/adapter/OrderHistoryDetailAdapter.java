 ...
 */
public class OrderHistoryDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    int flag;
    String payment;
    public OrderHistoryDetailAdapter(ArrayList<ProductPojos> arrayList,int count,String payment_mode) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_HEADER:
                ...
                return image;
            case TYPE_MIDDLE:
                ViewGroup vGroupText = (ViewGroup) mInflater.inflate(R.layout.orderhistory_items_bottom, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof HeaderHolder) {
            ...
            ((HeaderHolder) holder).textViewList.get(Constants.INT_THREE).setVisibility(View.INVISIBLE);
            ((HeaderHolder) holder).textViewList.get(Constants.INT_FOUR).setVisibility(View.INVISIBLE);
           ...
           ((MiddleHolder) holder).relativeLayoutList.get(Constants.INT_TWO).setVisibility(View.GONE);

            ((MiddleHolder) holder).textViewList.get(Constants.INT_FIVE).setText(payment);
            ((MiddleHolder) holder).textViewList.get(Constants.INT_SIX).setText(DataSingleton.getInstance().getCartArray().getOrder_status());
            ((MiddleHolder) holder).textViewList.get(Constants.INT_SEVEN).setText(DataSingleton.getInstance().getCartArray().getOrder_id());
    ...
    class HeaderHolder extends RecyclerView.ViewHolder{
        ...
        @BindViews({R.id.product_name,R.id.product_price,R.id.quantity,R.id.minus,R.id.plus})
...
//        }
    ...
    class MiddleHolder extends RecyclerView.ViewHolder {
        ...
        @BindViews({R.id.item_count,R.id.subtotal,R.id.package_charge,R.id.grand_total,R.id.delivery_charge,R.id.payment_mode,R.id.order_status,R.id.order_id})
        List<TextView> textViewList;

        @BindViews({R.id.package_view,R.id.delivery_view})
        List<View> viewList;
        @BindViews({R.id.package_layout,R.id.delivery_layout,R.id.addMoreItems})
