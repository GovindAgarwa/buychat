...
public class ElectronicsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ElectronicsAdapter(Context context,List<ProductPojos> mListData) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder  {
        ...
        @BindViews({R.id.product_name,R.id.product_description,R.id.product_rating,R.id.product_review_count,R.id.product_price,R.id.offer_price,R.id.discount})
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.electorincs_litems, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if(holder instanceof ProgressViewHolder){
            ...
            if (holder instanceof MyViewHolder) {
                ...
                ((MyViewHolder) holder).textViewList.get(Constants.INT_ONE).setText(mListData.get(position).getProduct_short_description());
                ((MyViewHolder) holder).textViewList.get(Constants.INT_FOUR).setText(Constants.MONEY_ICON+Float.valueOf(mListData.get(position).getProduct_price()));
                ...
                if(mListData.get(position).getIs_discount().equals("0")){
                    ...
                    ((MyViewHolder) holder).textViewList.get(Constants.INT_SIX).setVisibility(View.GONE);
                }else{
                    ...
                    ((MyViewHolder) holder).textViewList.get(Constants.INT_SIX).setText(mListData.get(position).getDiscount()+Constants.DISCOUNT);
                    ...
                    ((MyViewHolder) holder).textViewList.get(Constants.INT_SIX).setVisibility(View.VISIBLE);
                }
