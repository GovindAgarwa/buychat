 ...
 */
public class MovieTaxiHotelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public MovieTaxiHotelAdapter(Context context, List<ShopsPojo> mListData, CustomClickListner onItemClickClistner) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.movie_taxi_hotel_items, parent, false);
