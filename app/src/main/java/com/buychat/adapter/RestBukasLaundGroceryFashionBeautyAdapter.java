 ...
 */
public class RestBukasLaundGroceryFashionBeautyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RestBukasLaundGroceryFashionBeautyAdapter(Context context,List<ShopsPojo> mListData, CustomClickListner onItemClickClistner) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType==VIEW_ITEM) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.rest_bukas_laund_grocery_fashion_beauty_item, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof ProgressViewHolder) {
            ...
            if (holder instanceof MyViewHolder) {
                ...
                ((MyViewHolder) holder).order_time.setText(Constants.Min_Order+Constants.MONEY_ICON+mListData.get(position).getMin_order_value() +" | "+Constants.Delivery_time+mListData.get(position).getDelivery_time());
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @BindView(R.id.logos_name) TextViewRegular name;
