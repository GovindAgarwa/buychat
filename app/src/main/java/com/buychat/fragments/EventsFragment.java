 ...
 */
public class EventsFragment extends Fragment implements CustomClickListner,Callback<JsonObject>,SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        ...
        adapter = new EventsAdapter(getActivity(),arraylistCats,EventsFragment.this);
    ...
    public void filter(String query){
        ...
        if(arraylistCats.size() != 0) {
            ...
            adapter = new EventsAdapter(getActivity(), filteredList, EventsFragment.this);
            recyclerView.setAdapter(adapter);
            adapter.notifyDataSetChanged();
        }
    }
