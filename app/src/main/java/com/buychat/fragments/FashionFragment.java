 ...
 */
public class FashionFragment extends Fragment implements Callback<JsonObject> ,RecyclerItemClickListener.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener{


    public static FashionFragment newInstance(int positions,ArrayList<CategoriesPojos> categoriesPojoses,int pos) {
     //   position = pos;
...
//    private static int position;
    ...
    public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        ...
        adapter = new FashionAdapter(getActivity(),arrayList);
