 ...
 */
public class RestBukLadEduFragment extends Fragment implements CustomClickListner,Callback<JsonObject>,SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        ...
        adapter = new RestBukasLaundGroceryFashionBeautyAdapter(getActivity(),arraylistCats,RestBukLadEduFragment.this);
    ...
    public void filter(String query){
        ...
        if(arraylistCats.size() != 0 || !query.isEmpty()) {
            ...
            adapter = new RestBukasLaundGroceryFashionBeautyAdapter(getActivity(), filteredList, RestBukLadEduFragment.this);
            recyclerView.setAdapter(adapter);
            adapter.notifyDataSetChanged();
        }
    }
