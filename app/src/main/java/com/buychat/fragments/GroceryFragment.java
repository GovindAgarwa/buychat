 ...
 */
public class GroceryFragment extends Fragment implements Callback<JsonObject>,RecyclerItemClickListener.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener {


    public static GroceryFragment newInstance(int positions,ArrayList<CategoriesPojos> categoriesPojoses,int pos) {
   //     position = pos;
