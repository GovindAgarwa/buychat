 ...
 */
public class ElectronicsFragment extends Fragment implements Callback<JsonObject>,RecyclerItemClickListener.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener {


    public static ElectronicsFragment newInstance(int positions,ArrayList<CategoriesPojos> categoriesPojoses,int pos) {
        //   position = pos;
...
//    private static int position;
    ...
    public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        ...
        adapter = new ElectronicsAdapter(getActivity(),arrayList);
