...
import com.buychat.adapter.PayBillAdapter;
 ...
 */
public class MovieTaxiHotelFragment extends Fragment implements CustomClickListner,Callback<JsonObject>,SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        ...
        adapter = new MovieTaxiHotelAdapter(getActivity(),arraylistCats,MovieTaxiHotelFragment.this);
    ...
    public void filter(String query){
        ...
        if(arraylistCats.size() != 0) {
            ...
            adapter = new MovieTaxiHotelAdapter(getActivity(), filteredList, MovieTaxiHotelFragment.this);
            recyclerView.setAdapter(adapter);
            adapter.notifyDataSetChanged();
        }
    }
