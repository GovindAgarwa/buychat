 ...
 */
public class PayBillFragment extends Fragment implements CustomClickListner,Callback<JsonObject>,SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
        ...
        adapter = new PayBillAdapter(getActivity(),arraylistCats,PayBillFragment.this);
    ...
    public void filter(String query){
        ...
        if(arraylistCats.size() != 0) {
            ...
            adapter = new PayBillAdapter(getActivity(), filteredList, PayBillFragment.this);
            recyclerView.setAdapter(adapter);
            adapter.notifyDataSetChanged();
        }
    }
