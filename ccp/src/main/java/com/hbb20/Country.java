...
class Country {
    ...
    /**
     * This function parses the raw/countries.xml.xml file, and get list of all the countries.xml.
     *
     * @param context: required to access application resources (where country.xml is).
     * @return List of all the countries.xml available in xml file.
     */
     ...
     *
     * @param preferredCountries is list of preference countries.xml.
    ...
    private static Country getCountryForCode(CountryCodePicker.Language language, List<Country> preferredCountries, String code) {
        ...
        /**
         * check in preferred countries.xml
         */
     ...
     * @param nameCode country name code. i.e US or us or Au. See countries.xml.xml for all code names.
     * @return Country that has phone code as @param code.
     * or returns null if no country matches given code.
     */
     ...
     *
     * @param preferredCountries countries.xml of preference
    ...
    /**
     * This will return all the countries.xml. No preference is manages.
    ...
    /*public static List<Country> getLibraryMasterCountriesSpanish() {
        List<Country> countries.xml = new ArrayList<>();
